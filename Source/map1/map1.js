...
function initalMap1() {
    ...
    if( _map_deco[0] == 1){
        ...
        addTB("First you need locate yourself. Then find your network gate. \
            Thridly routing to your destination. Finally you know the \
            destination you want.");
        addTB("If you choose IT stream in our department. You will learn more \
            about Internet~");
    }
